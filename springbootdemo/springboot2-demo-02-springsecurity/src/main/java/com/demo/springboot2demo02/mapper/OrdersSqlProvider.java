...
import com.demo.springboot2demo02.model.OrdersExample.Criteria;
import com.demo.springboot2demo02.model.OrdersExample.Criterion;
...
public class OrdersSqlProvider {
    ...
    public String insertSelective(Orders record) {
        ...
        if (record.getCustId() != null) {
            sql.VALUES("cust_id", "#{custId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getOrderDate() != null) {
            sql.SET("order_date = #{record.orderDate,jdbcType=TIMESTAMP}");
        }
        
        if (record.getCustId() != null) {
            sql.SET("cust_id = #{record.custId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Orders record) {
        ...
        if (record.getCustId() != null) {
            sql.SET("cust_id = #{custId,jdbcType=INTEGER}");
        }
        
        sql.WHERE("order_num = #{orderNum,jdbcType=INTEGER}");
