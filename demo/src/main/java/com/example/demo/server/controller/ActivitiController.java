...
import com.example.demo.server.service.ActivitiConsumerService;
...
public class ActivitiController {
    ...
    public Boolean deleteDeployment(String id){
        ...
        return activitiConsumerService.deleteDeployment(id);//"test01.bpmn"
    }
    /**
    ...
    @GetMapping("/isProcessActive")
    public boolean isProcessActive(String taskId){
        System.out.println("taskId: "+taskId);
        return activitiConsumerService.isProcessActive(taskId);
    }
