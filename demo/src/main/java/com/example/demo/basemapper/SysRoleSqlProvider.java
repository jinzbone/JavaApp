...
import com.example.demo.basemodel.SysRoleExample.Criteria;
import com.example.demo.basemodel.SysRoleExample.Criterion;
...
public class SysRoleSqlProvider {
    ...
    public String insertSelective(SysRole record) {
        ...
        if (record.getAvailable() != null) {
            VALUES("available", "#{available,jdbcType=BIT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAvailable() != null) {
            SET("available = #{record.available,jdbcType=BIT}");
        }
